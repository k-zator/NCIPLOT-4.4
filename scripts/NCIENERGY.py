...
from spatial.calculate_NCI_energy import calculate_energy_cluster, calculate_energy_single, calculate_charge_correction
...
if isovalue == 1.0 and l_large == 0.2 and l_small == 0.02 and intermol == True:
    ...
    if ispromol:
        ...
        E_charge_correction = calculate_charge_correction(mol1, mol2, ispromol, total_charges)
        if cluster:
